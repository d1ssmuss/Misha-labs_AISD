...
def generate_plan():
    ...
    # Генерация всех возможных комбинаций (одиночные и парные)
    valid_combinations = [()] + list(combinations(ice_creams, 1)) + list(combinations(ice_creams, 2))
    ...
    for day in range(7):  # 7 дней в неделе
        available_combinations = [
            ...
            if is_valid_combination(combo) and
